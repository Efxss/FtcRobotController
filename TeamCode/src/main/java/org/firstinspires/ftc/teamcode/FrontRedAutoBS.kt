...
@Disabled
//@Autonomous(name = "Front Red Auto (BrainStem)", group = "Main Red")
class FrontRedAutoBS : OpMode() {
    ...
    @Volatile var pathState: Int = 0
    @Volatile var timerState = false
    ...
    private val spike2pre    = Pose(87.0, 130.0, Math.toRadians(0.0))
    private val spike2       = Pose(88.0, 130.0, Math.toRadians(180.0))
