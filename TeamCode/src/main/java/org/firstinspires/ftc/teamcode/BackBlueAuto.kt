...
@Autonomous(name = "Back Blue Auto (12 ball)", group = "Main Blue")
class BackBlueAuto : OpMode() {
    ...
    private val spikeScore   = Pose(65.0,  18.0,  Math.toRadians(116.0))
    private val spikeScore2  = Pose(65.0,  18.0,  Math.toRadians(115.0))
    private val spikeScore3  = Pose(65.0,  19.0,  Math.toRadians(111.0))
    private val spike1pre    = Pose(53.1,  29.0,  Math.toRadians(180.0))
    private val spike1       = Pose(36.6,  29.0,  Math.toRadians(180.0))
    private val spike2pre    = Pose(53.0,  52.0,  Math.toRadians(180.0))
    private val spike2       = Pose(36.6,  52.0,  Math.toRadians(180.0))
